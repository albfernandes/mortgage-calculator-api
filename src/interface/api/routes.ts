...
const models: TsoaRoute.Models = {
    "Mortgage": {
        "dataType": "refObject",
        "properties": {
            "paymentPerPaymentSchedule": {"dataType":"double","required":true},
        },
    ...
    "PaymentScheduleEnum": {
        "dataType": "refEnum",
        "enums": ["weekly","bi-weekly","monthly"],
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
};
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/()(mortgage-service/api)/v1/payment-schedule',

            async function MortgageController_getPaymentPerPaymentSchedule(request: any, response: any, next: any) {
            const args = {
                    propertyPrice: {"in":"query","name":"propertyPrice","required":true,"dataType":"double"},
                    downPayment: {"in":"query","name":"downPayment","required":true,"dataType":"double"},
                    annualInterestRate: {"in":"query","name":"annualInterestRate","required":true,"dataType":"double"},
                    amortizationPeriod: {"in":"query","name":"amortizationPeriod","required":true,"ref":"SmallInt"},
                    paymentSchedule: {"in":"query","name":"paymentSchedule","required":true,"ref":"PaymentScheduleEnum"},
            };
            ...
            try {
                ...
                const controller: any = await container.get<MortgageController>(MortgageController);
                if (typeof controller['setStatus'] === 'function') {
                controller.setStatus(undefined);
                }


              const promise = controller.getPaymentPerPaymentSchedule.apply(controller, validatedArgs as any);
